      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">Handmade sourdough bread and custom cake pops, baked with love in San Diego.</p>
          ...
          <div>
            <h4 className="font-serif text-lg mb-4 text-wheat">Quick Links</h4>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-500 text-sm">&copy; 2026 Auntie Lu&apos;s Bakery. Sourdough &amp; Cake Pops. San Diego.</p>
        </div>
      </div>
    </footer>
  )
